...
contextBridge.exposeInMainWorld('desktopWindow', {
  ...
  // 酷狗音乐（直连官方API）
  kugouLoginQrKey: (platform) => ipcRenderer.invoke('kugou-login-qr-key', platform || ''),
  kugouLoginQrCheck: (key) => ipcRenderer.invoke('kugou-login-qr-check', key),
  kugouLoginCookie: (cookie) => ipcRenderer.invoke('kugou-login-cookie', cookie),
  kugouLoginStatus: () => ipcRenderer.invoke('kugou-login-status'),
  kugouLogout: () => ipcRenderer.invoke('kugou-logout'),
  kugouPlatform: (mode) => ipcRenderer.invoke('kugou-platform', mode),
  kugouSearch: (keywords, limit, type) => ipcRenderer.invoke('kugou-search', keywords, limit, type),
  kugouSongUrl: (hash, albumId, albumAudioId, quality) => ipcRenderer.invoke('kugou-song-url', hash, albumId, albumAudioId, quality),
  kugouLyric: (id, accesskey) => ipcRenderer.invoke('kugou-lyric', id, accesskey),
  kugouUserPlaylists: () => ipcRenderer.invoke('kugou-user-playlists'),
  kugouPlaylistTracks: (id, page, pagesize, listid) => ipcRenderer.invoke('kugou-playlist-tracks', id, page, pagesize, listid),
